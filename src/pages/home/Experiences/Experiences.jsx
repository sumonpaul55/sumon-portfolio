            ...
            <div className="container mx-auto">
                <div className='grid grid-cols-1 md:grid-cols-2 gap-10'>
                    ...
                    <div className='mt-0 md:mt-14' data-aos="fade-left">
                        <Accordion className='mt-10 md:p-8 duration-200'>
                            <AccordionItem className=''>
                                <AccordionItemHeading>
                                    <AccordionItemButton className='font-bold border border-slate-600 text-white bg-slate-900 p-3 text-sm md:text-md hover:text-pink-500 duration-200'>
                                        HTML, CSS, and JavaScript Mastery
                                    </AccordionItemButton>
                                </AccordionItemHeading>
                                <AccordionItemPanel className='p-3 border border-slate-600 bg-white'>
