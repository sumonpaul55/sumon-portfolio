            ...
            <div className="container mx-auto">
                ...
                <div className='grid grid-cols-2 gap-1 md:gap-6 sm:grid-cols-2 md:grid-cols-3 lg:grid-cols-4 mt-20'>
                    {skills?.map((skills, idx) => (
                        <div key={idx} className='shadow-lg rounded-lg bg-slate-500 text-white border-slate-500 py-2 p-1 flex justify-center items-center border overflow-hidden hover:scale-105 duration-200'>
